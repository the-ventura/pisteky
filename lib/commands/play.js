...
export const play = {
  ...
  usage: '!play [competitive] [style Shooter] [speed 4] [nocal]',
  execute (client, message) {
    const options = messageArguments(message, { 'competitive': 'flag', 'style': 'map', 'speed': 'map', 'nocal': 'flag' })
...
export const games = {
  ...
  usage: '!games [competitive] [style Shooter] [speed 4] [nocal]',
  execute (client, message) {
    const options = messageArguments(message, { 'competitive': 'flag', 'style': 'map', 'speed': 'map', 'nocal': 'flag' })
